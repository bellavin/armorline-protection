...
gulp.task(`server`, function () {
  ...
  gulp.watch(`src/blocks/**/*.less`, gulp.series(`css`));
  gulp.watch(`src/pug/**/*.pug`, gulp.series(`pug`, `refresh`));
  gulp.watch(`src/pages/*.pug`, gulp.series(`pug`, `refresh`));
  gulp.watch(`src/blocks/**/*.pug`, gulp.series(`pug`, `refresh`));

  gulp.watch(`src/img/sprite/*.svg`, gulp.series(`copysvg`, `sprite`, `pug`, `refresh`));
